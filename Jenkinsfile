pipeline {
    ...
    parameters {
        string(name: 'HARBOR_HOST', defaultValue: '172.18.30.107', description: 'harbor仓库地址')
        string(name: 'DOCKER_IMAGE', defaultValue: 'test_habor/pipeline-demo', description: 'docker镜像名')
